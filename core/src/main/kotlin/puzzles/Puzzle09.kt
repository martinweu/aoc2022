...
class Puzzle09P1 : Puzzle() {
    override fun solve(lines: List<String>): String {
        ...
        val steps = Puzzle09.parseSteps(lines)

        var positionHead = Puzzle09.Vector2D(0, 0)
        var positionTail = positionHead
        var positionsTail = mutableListOf<Puzzle09.Vector2D>()
...
companion object {
    public fun parseSteps(lines: List<String>) = lines.map {
        val parts = it.split(" ")
...
class Puzzle09P2 : Puzzle() {
    override fun solve(lines: List<String>): String {
        ...
        var start = Puzzle09.Vector2D(0, 0)
